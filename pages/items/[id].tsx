  ...
  return (
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex items-center py-3 border-t border-b cursor-pointer spance-x-3">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button
              type="button"
              className="flex-1 py-3 font-medium text-white bg-orange-500 rounded-md focus:outline-none focus:right-2 hover:bg-orange-600 focus:ring-offset-2 focus:ring-orange-500"
            >
              Talk to seller
            </button>
            <button
